...
static const char qt_meta_stringdata_Gui[] = {
    "Gui\0\0value\0update(float)\0"
};

const QMetaObject Gui::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Gui,
      qt_meta_data_Gui, 0 }
};
...
void *Gui::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "AEffEditor"))
        return static_cast< AEffEditor*>(const_cast< Gui*>(this));
