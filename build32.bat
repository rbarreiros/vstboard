...
set UPX_PATH="../../vstboard/tools/upx/upx.exe"
%UPX_PATH% -q ".\installer\VstBoard.exe"
%UPX_PATH% -q ".\installer\VstBoardPlugin.dll"
%UPX_PATH% -q ".\installer\VstBoard.dll"
%UPX_PATH% -q ".\installer\QtGui4.dll"
%UPX_PATH% -q ".\installer\QtCore4.dll"
%UPX_PATH% -q ".\installer\QtScript4.dll"
%UPX_PATH% -q ".\installer\QtSolutions_MFCMigrationFramework-head.dll"
